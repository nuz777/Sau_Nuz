          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.3, delay: isMobile ? 0 : 0.2 }}
                className="flex justify-center"
              >
                <div className="relative w-40 h-40 md:w-80 md:h-80 rounded-xl overflow-hidden shadow-2xl">
                  <img
                    src={img}
                    alt={name}
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.3, delay: isMobile ? 0 : 0.3 }}
              ...
              >
                ...
                <motion.a
                  ...
                  className="inline-flex items-center gap-2 mt-4 md:mt-6 px-5 md:px-6 py-2 md:py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold transition text-sm md:text-base"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.3, delay: isMobile ? 0 : 1 }}
                >
